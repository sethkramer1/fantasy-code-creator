...
export function GamesList({
  ...
  return <div className="glass-panel bg-white/80 backdrop-blur-sm border border-gray-100 rounded-xl p-6 shadow-sm">
      ...
      {isLoading ? <div className="flex justify-center py-8">
          ...
          {games.map(game => <button key={game.id} onClick={() => onGameClick(game.id)} className="p-4 rounded-lg bg-white border border-gray-100 hover:border-gray-200 transition-all text-left group">
